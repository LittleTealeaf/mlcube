...
class Replay(Puzzle):
    def __init__(self, capacity: int = 100_000):
        ...
        ...
    def sample_replay(self, count: int) -> tuple[list[list[int]], list[int], list[float], list[list[int]]]:
        ...
    def is_at_capacity(self) -> bool:
        ...

class PyReplay2x2(Replay):
    def create_evaluation_target(self) -> PyCube2x2:
        ...

class PyReplay3x3(Replay):
    def create_evaluation_target(self) -> PyCube3x3:
        ...
