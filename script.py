...
def main():
  ...
  agent = Agent([264, 202, 141, 80],"agents/2")


  target_interval = 500
  eval_interval = 100
  save_interval = 10
  learning_rate_function = lambda epoch: exponential_decay(exponential_decay(1,epoch%target_interval,0.95,2),epoch,0.9,target_interval)
